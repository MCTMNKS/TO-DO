...
showAlertDialog(BuildContext context) async {
  ...
  Widget continueButton = FlatButton(
    ...
    onPressed:  () {
      ...
      Toast.show("Bütün veri temizlendi.", context,
  ...
  AlertDialog alert = AlertDialog(
    content: Text("Bütün veriyi temizlemek istediğinize emin misiniz? Bu işlem geri alınamaz."),
    actions: [
      cancelButton,
      continueButton,
    ],
                      ...
                      child: Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: new Container(
                              ...
                              child: new Text("Bütün Veriyi Temizle",
                                  style: new TextStyle(
              ...
              Padding(
                ...
                child: new Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () => launch('https://www.adu.edu.tr/'),
                  ),
                ),
              ),
              Padding(
